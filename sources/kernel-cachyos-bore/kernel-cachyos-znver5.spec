...
# GCC/Clang -march/-mtune for the kernel build (CachyOS Kconfig may not expose
# Zen 5 yet; KCFLAGS applies after arch defaults and overrides -march).
%define _kernel_march znver5
...
%build
    export KCFLAGS="-march=%{_kernel_march} -mtune=%{_kernel_march}"
    export KCPPFLAGS="-march=%{_kernel_march} -mtune=%{_kernel_march}"
